module FormlessI.Transform.Record where

import Prelude

import Data.Newtype (class Newtype, unwrap, wrap)
import FormlessI.Types.Form (InputField, InputFunction, OutputField)
...
-- | type for compatibility with FormlessI
wrapInputFields
  :: ∀ form is is'
...
-- | the InputField type for compatibility with FormlessI
wrapInputFunctions
  :: ∀ form ifs ifs'
